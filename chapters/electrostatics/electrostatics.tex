...
variants of the biological nanopores \glsfirst{plyab}, \glsfirst{frac} and \glsfirst{clya} by numerically
solving the \glsfirst{pbe} for their atomistic models. After describing our computational methods, we begin
...
A schematic overview of all the computational methods, and how they are linked together, can be found in
~\cref{fig:electrostatics_overview_diagram}.
...
voltage \si{\kbt\per\ec}), $\permittivity$ the local permittivity, and $\scd$ the charge density. For a
...
\subsection{Energetics of {ssDNA} translocation through {WtFraC} and {ReFraC}}
%
...
In the last section, we investigated the electrostatics of five \gls{clya} variants: AS, R, RR, RR$_56$, and
