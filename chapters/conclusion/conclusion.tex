...
As an example of the role of electrostatics during protein translocation, we computed the electrostatic
...
biological nanopores: the \glsfirst{epnp-ns} equations. It considers steric ion-ion
...
experiments revealed that the binding of the negatively charged inhibitor molecule \glsfirst{mtx} to \DHFRt{}
