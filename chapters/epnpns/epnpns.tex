...
framework and its application to the \glsfirst{clya} nanopore, respectively. The remainder of the
...
\paragraph{Ion electrophoretic mobilities.}cation$\mobility^c_{\Cl}$,
