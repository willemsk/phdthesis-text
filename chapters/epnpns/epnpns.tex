...
\glsreset{ahl}\gls{ahl} nanopore. Similar reductions in ion diffusion coefficients have been proposed to
...
\begin{figure*}[!b]
  ...
  \caption[Concentration dependency of ion self-diffusion coefficients in \ce{NaCl}.]%
    {%
...
\begin{figure*}[p]
  ...
  \caption[Concentration dependency of the electrolyte viscosity, density and relative permittivity in
  \ce{NaCl}.]%
    {%
      ...
      respectively. Circles represent the experimental data and solid lines the fitted equation with the grey
...
\begin{figure*}[!t]
  ...
  \caption[Wall distance dependency of ion self-diffusion coefficients, mobilities and electrolyte
  viscosity.]%
    {%
