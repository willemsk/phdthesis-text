...
\caption[Structure of the Pleurotolysin AB (PlyAB) porin.]{%
  ...
  \cite{Lukoyanova-Kondos-2015}), formed by 13 identical subunits which are each composed of two \gls{plya}
  (pink) one \gls{plyb} (green) protein chains. The full pore is \SI{13}{\nm} high with external diameters of
  ...
  %
  Cartoon view of the water-soluble monomer configurations of \gls{plya} (\pdbid{4OEB}
  \cite{Lukoyanova-Kondos-2015}) and \gls{plyb} (\pdbid{4OEJ} \cite{Lukoyanova-Kondos-2015}), aligned according to
...
which is composed of two lipid binding \gls{plya} and a single pore forming \gls{plyb} protein chain (\cref{fig:plyab_pore_side,fig:plyab_pore_top}).
...
water-soluble \gls{plyb} structure (\pdbid{4OEJ} \cite{Lukoyanova-Kondos-2015}) can be subdivided in a \tb-rich
