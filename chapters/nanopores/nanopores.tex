...
Nanopores are not only extremely versatile, but their inherently small size and relative simple read-out
...
a proper protective layer, such as \ce{HfO2}, the size of a \ce{Si3N4} pore is known to `drift' due slow
...
monomers (\ce{M}) undergo a rapid transition ($t_{1/2} \approx \SI{80}{\second}$) to a molten globule-like
...
and amino acids~\cite{Restrepo-Perez-2019a}, making it an promising candidate for protein sequencing
