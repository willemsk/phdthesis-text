...
\caption[Structure of the \ta-hemolysin (\ta HL) porin.]{%
  ...
  (protomer) highlighted in color and the location of the lipid bilayer indicated in blue. The pore is shaped
  ...
  sizes of the \cisi{} vestibule, the constriction and the transmembrane \tb-barrel.
  %
  (\subref{fig:ahl_monomer})
  %
  The \SI{34}{\kDa} water-soluble \gls{ahl} monomer (\pdbid{4YHD} \cite{Sugawara-2015}) 
  (\subref{fig:ahl_protomer})
  %
  A single \gls{ahl} protomer (\pdbid{7AHL} \cite{Song-1996}), 
  %
