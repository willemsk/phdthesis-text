...
phenomenon leads to the formation of the \glsfirst{edl} (\cref{fig:nanopores_edl_overview}), which describes
...
in the system (typically hydrogen bond vibration), leading to the use of time steps in the order of \SI{1}{\fs}
