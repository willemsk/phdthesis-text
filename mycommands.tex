...
\newcommand{\pna}{\permeability_{\ce{Na+}}}
...
% \newcommand{\kT}{\boltzmann\temperature}
...
% Electrostatic chapter
\newcommand{\apbsgrid}[4]{$#1 \times #2 \times #3 $~\si{#4}}

% PBE
\newcommand{\ionaccess}{\kappa}
...
% Energy
\newcommand{\gibbs}{G}
\newcommand{\energyelec}{\Delta \gibbs^{\mathrm{el}}}
...
% Permeability ration
\newcommand{\permeabilityratio}[2]{ P_{#1} / P_{#2} }
...
\newcommand{\mmps}{\milli\meter\per\second}
